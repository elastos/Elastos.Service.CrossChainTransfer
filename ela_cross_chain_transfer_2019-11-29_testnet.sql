...
# Generation Time: 2019-11-29 03:02:38 +0000
# ************************************************************
...
VALUES
	(1,'ELA(main chain)','http://54.64.220.165:21334',0,1,'number scatter verb cube gossip toilet solve output copper credit only leisure',1,0.1,0.5),
	(2,'ELA(DID side chain)','http://54.64.220.165:21604',1,1,'flip business asset share afraid palm planet ordinary trade ketchup blood sell',1,0.1,0.5),
	(3,'ELA/ETHSC(ETH side chain)','http://rpc.elaeth.io:8545',2,1,'safe topic ring mask chat tourist hello can ignore margin erode gossip',1,0.1,0.5);
