...
VALUES
	...
	(2,'did side chain','http://54.64.220.165:21604',1,1,'flip business asset share afraid palm planet ordinary trade ketchup blood sell',1,0.1,0.5),
	(3,'eth side chain','http://rpc.elaeth.io:8545',2,1,'safe topic ring mask chat tourist hello can ignore margin erode gossip',1,0.1,0.5);
