...
VALUES
	...
	(3,'ELA/ETHSC(ETH side chain)','https://api-esc.elaphant.app/api/1/eth/wrap',2,0,'safe topic ring mask chat tourist hello can ignore margin erode gossip',1,0.1,0.5);
